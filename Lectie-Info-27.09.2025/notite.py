...
"""
in c++ ca sa ramanem in scope-ul unui for/if/while vom folosi acolada {}
...
for i in range(20): #in python se face automat indexarea de la 0 si merge pana la target - 1 => for-ul nostru merge de la 0 la 19
    print(i)
